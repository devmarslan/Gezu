...
function localeUrl(t = document) {
  ...
  "/" != e &&
    ...
    $$4(
      `a[href*="${i}/"]:not([href*="${i + e}"],[href*="@"],[href*="preview_theme_id="])`,
      t,
    ).forEach((t) =>
    ...
    if (getterGet(_options_slider, this).closePopover) {
      const t = 10,
        e = (e) => {
          ...
          if (i.pointerDown()) return;
          const r = n.get() - s.get();
          Math.abs(r) > t &&
            $$4(`hdt-popover[data-change="${this.id}"] dialog[open]`).forEach(
              (t) => {
...
class SlideCounter extends HTMLElement {
  ...
  connectedCallback() {
    ...
    (getterGet(_slider_api, getterGet(_slider_counter, this)).on(
      "init",
      getterRunFn(_update_total_counter, this, update_total_counter_fn).bind(
        this,
      ),
      { signal: t },
    ),
...
class btnTooltip extends HTMLElement {
  ...
  get appendEl() {
    return this.hasAttribute("inner")
      ? this.closest("dialog, .shopify-section") || this
      : document.body;
  }
}
...
class DeclarativeShadowElement extends HTMLElement {
  connectedCallback() {
    if (!this.shadowRoot) {
      ...
      if (!(t instanceof HTMLTemplateElement)) return;
      this.attachShadow({ mode: "open" }).append(t.content.cloneNode(!0));
    }
  }
}
var dialogsOpen = [];
class DialogComponent extends DeclarativeShadowElement {
  ...
  connectedCallback() {
    if (!(this.dialog = $4("dialog", this))) return;
    ((this.#e = this.dialog.hasAttribute("scroll-lock")),
      (this.#t = new AbortController()));
    const { signal: t } = this.#t;
    (super.connectedCallback(),
      this.dialog.addEventListener(
        ...
        (t) => {
          !this.#i(t) ||
            (this.hasAttribute("nested") && dialogsOpen[0] !== this.dialogId) ||
            this.close();
        },
        { signal: t },
      ),
  ...
  async open(t = !1) {
    ...
    (this.show,
      this.#e && this._openedAsModal && html.setAttribute("scroll-lock", ""),
    ...
    const e = this.animateDialogOpen();
    (t && e.finish(),
      await e.finished,
  ...
  #i(t) {
    ...
    return t.target instanceof HTMLDialogElement ||
...
document.addEventListener("click", (t) => {
  ...
  if (
    ...
    (i.hasAttribute("nested") && dialogsOpen[0] !== i.id)
  )
    return;
  ((i.btnOpening = e), t.preventDefault(), t.stopImmediatePropagation());
  const s = $id4(e.getAttribute("close-dialog"));
  (s?.parentElement?.close(),
    $$4("hdt-popover[data-auto-close] > dialog[open]").forEach((t) => {
      t?.parentElement?._openedAsModal ||
        t.id == i.id ||
        t.parentElement.close(!0);
    }),
...
class DrawerComponent extends DialogComponent {
  ...
  set transform(t) {
    ((this.#s = ["translate3d(0, 0, 0)"]),
      "right" === t
        ? this.#s.push(`translate3d(${isRTL ? "-" : ""}100%, 0, 0)`)
        : "bottom" === t
          ? this.#s.push("translate3d(0, 100%, 0)")
          : "top" === t
            ? this.#s.push("translate3d(0, -100%, 0)")
            : this.#s.push(`translate3d(${isRTL ? "" : "-"}100%, 0, 0)`));
  }
  get pos() {
    ...
    return t[1] && window.innerWidth >= Number(t[0])
      ? t[1]
  ...
  animateDialogOpen() {
    return animate(
      this.dialog,
      { transform: this.#s.reverse() },
      { duration: 0.5, easing: [0.19, 1, 0.22, 1] },
    );
  }
  animateDialogClose() {
    return animate(
...
class ModalComponent extends DialogComponent {
  animateDialogOpen() {
    return animate(
      ...
      { duration: 0.45, easing: [0.19, 1, 0.22, 1] },
    );
  }
  animateDialogClose() {
    return animate(
      this.dialog,
      { opacity: [1, 0], transform: ["translateX(0)", "translateX(80px)"] },
      { duration: 0.45, easing: [0.19, 1, 0.22, 1] },
    );
  }
}
    ...
    return this._openedAsModal
      ? timeline([
          [
            ...
            { at: "-0.1", duration: 0.25, easing: [0.645, 0.045, 0.355, 1] },
          ],
        ])
      : timeline([
          [
    ...
    (super(),
      (window.innerWidth < 768 && this.hasAttribute("desktop")) ||
        requestIdleCallback(() => {
          ...
          t.firstElementChild &&
            document.body !== t.parentNode &&
            (document.body.appendChild(t), this.remove());
        }));
  }
}
...
const {
  ...
  cartDrawerRender: cartDrawerRender,
  cartMainRender: cartMainRender,
} = ThemeEvents;
class CartDrawer extends DrawerComponent {
  ...
  connectedCallback() {
    ...
    const { signal: t } = this.#t;
    (document.addEventListener(cartUpdate, this.#r.bind(this), { signal: t }),
      document.addEventListener(cartReload, this.#a.bind(this), { signal: t }),
      window.addEventListener("pageshow", this.#o.bind(this), { signal: t }));
  }
  disconnectedCallback() {
  ...
  async #r(t) {
    ...
    for (const t of this.#n) {
      ...
      e &&
        i &&
        (t == this.#n[0]
          ? ($4(".hdt-progress-bar", i).style.setProperty(
              "--progress-rate",
              $4(".hdt-progress-bar", e).style.getPropertyValue(
                "--progress-rate",
              ),
            ),
            e.replaceWith(i),
            ($4(".hdt-progress-bar", this).now = $4(
              ".hdt-progress-bar",
              i,
            ).getAttribute("aria-valuenow")))
          : t != this.#n[3]
            ? e.replaceWith(i)
            : (i.dataset.id && e.dataset.id === i.dataset.id) ||
              e.replaceWith(i));
    }
    if (
      (($4("cart-items-component", this).innerHTML = $4(
      ...
      t.indexOf("go_") > -1
        ? (window.location.href = `${Shopify.routes.root}${"go_cart_page" == t ? "cart" : "checkout"}`)
        : "open_cart_drawer" == t && this.open();
    }
  }
  async #a() {
    try {
      const t = fetchConfig("json", {
        ...
        e = await fetch(`${Shopify.routes.root}cart/update`, { ...t });
      if (!e.ok) throw new Error("Network response was not ok");
      const i = await e.json();
      this.#r.call(this, {
        detail: { cartData: i, source: "reload", actionAfterATC: "no_action" },
      });
    } catch (t) {
...
class CartItemsComponent extends HTMLElement {
  ...
  #l(t) {
    ...
    if (i)
      return 0 === e
        ? this.onLineItemRemove(i)
        : void this.updateQuantity({ line: i, quantity: e, action: "change" });
  }
  onLineItemRemove(t) {
    this.updateQuantity({ line: t, quantity: 0, action: "clear" });
  }
  updateQuantity(t) {
    this.#d();
    ...
    fetch(
      `${Shopify.routes.root}cart/change.js`,
      fetchConfig("json", { body: n }),
    )
      .then((t) => t.text())
      .then(async (t) => {
        const i = JSON.parse(t);
        if (i.errors) return void this.#h(e, i);
        let n = animate(this, {}, { duration: 0 });
        if ("clear" === s) {
...
class CartMain extends HTMLElement {
  ...
  async #r(t) {
    ...
    if (
      (l &&
        ((h = $4(".hdt-progress-bar", l).getAttribute("aria-valuenow")),
        ($4(".hdt-progress-bar", l).valueNow = $4(
          ".hdt-progress-bar",
          this,
        ).getAttribute("aria-valuenow")),
        $4(".hdt-progress-bar", l).style.setProperty(
          "--progress-rate",
          $4(".hdt-progress-bar", this).style.getPropertyValue(
            "--progress-rate",
          ),
        )),
      ...
      l && ($4(".hdt-progress-bar", this).valueNow = h),
      document.dispatchEvent(new CustomEvent(currencyUpdate)),
...
class CountdownAmount extends HTMLElement {
  constructor() {
    ...
    let t = [...this.textContent].map(
      () =>
        `<hdt-countdown-number part="number" effect="${this.getAttribute("effect")}" style="display: inline-block">0</hdt-countdown-number>`,
    );
    ...
    null !== e &&
      ...
      animate(
        this.shadowRoot.firstElementChild,
        {
          opacity: [0, 1],
          transform: [
            `translateY(${this.e.Y2 || this.e.Y}px) rotate(${this.e.R}deg) scale(${this.e.S})`,
            "translateY(0) rotate(0deg) scale(1)",
          ],
        },
...
const countdown = {
  ...
  { CountdownStart: CountdownStart, CountdownEnd: CountdownEnd } = ThemeEvents;
class CountdownHybrid extends HTMLElement {
  ...
  constructor() {
    ...
    ((this.#u = Object.assign(
      ...
      (this.#_ = new Date(
        this.#u.datetime + (themeHDN.settings.shopTimezone || ""),
      )),
      (this.#m = $4(t, this)),
      (this.#g = $4(e, this)),
      (this.#b = $4(i, this)),
  ...
  connectedCallback() {
    ((this.#t = new AbortController()),
      ...
      (this.#p = setInterval(this.#v.bind(this), 1e3)),
      document.addEventListener(
        "visibilitychange",
        () => {
          "visible" === document.visibilityState && this.#v(!0, !0);
        },
        { signal: this.#t.signal },
      ));
  }
  disconnectedCallback() {
    (clearInterval(this.#p), this.#t.abort());
  }
  #v(t = !1, e = !1) {
    const i = new Date(),
      { actionElapsed: s, hasZero: n } = this.#u;
    if (this.#_ < i)
      return (
    ...
    let r = Math.abs((this.#_.getTime() - i.getTime()) / 1e3);
    ...
    (this.#m || (l = Math.min(a, 99)),
      this.#m?.updateAttr(o, n),
      this.#g?.updateAttr(l, n),
      this.#b?.updateAttr(d, n),
      this.#f?.updateAttr(h, n),
      (t || e) &&
        (e &&
        ...
        this.#b?.updateDelay(h, d),
        this.#f?.updateDelay(h)));
  }
}
class CountdownJS extends HTMLElement {
        ...
        (t
          ...
          .appendChild(
            document
              .createRange()
              .createContextualFragment(
                `<span part="numlist"><span part="num">0</span>${s}</span>`,
              ),
          ),
          (s = ""));
      }));
  ...
  updateAttr(t, e) {
    this.getAttribute("numbers") != t &&
      ((this.#y = e), this.setAttribute("numbers", t));
  }
  async attributeChangedCallback(t, e, i) {
    if (e === (i = Math.min(99, parseInt(i)))) return;
    (e || (e = Math.min(99, i + 1)), (e = parseInt(e)));
    ...
    (console.log("CountdownJS: ", e, i),
      $$4("[number]", this).forEach((t, e) => {
        const i = t.shadowRoot.firstElementChild.children.length - 1 - s[e],
          n = 1 == i ? 0 : i - 1;
        s[e] != parseInt(this.getAttribute("num")) &&
          (t.setAttribute("num", s[e]),
...
class CountdownCSS extends HTMLElement {
  ...
  constructor() {
    (super(),
      ...
      $$4("[number]", this).forEach((t, e) => {
        ...
        let i,
          s = "";
        for (i = e ? 9 : 5; i >= 0; i--) s += `<span part="num">${i}</span>`;
        (t
          .attachShadow({ mode: "open" })
          .appendChild(
            document
  ...
  updateAttr(t, e) {
    (this.getAttribute("numbers") == t && this.isMinutes) ||
      ((this.#y = e), this.isMinutes && this.setAttribute("numbers", t));
  }
  updateDelay(t, e) {
    let i,
      s,
    ...
    $$4("[number]", this).forEach((a, o) => {
      (e
        ? 0 == o
          ? ((i = 6 - r[0]), (s = 600), (n = 599 - (60 * r[1] + t)))
          : ((i = 10 - r[1]), (s = 60), (n = 59 - t))
        : 0 == o
          ? ((i = 6 - r[0]), (s = 10), (n = 9 - r[1]))
          : ((i = 10 - r[1]), (s = 1), (n = 0)),
...
class Marquee extends HTMLElement {
  ...
  connectedCallback() {
    ...
    (this._setup(),
      (this.#w = new ResizeObserver(this._setup.bind(this))),
      this.#w.observe(this),
  ...
  disconnectedCallback() {
    ((this._lastWidth = 0), this._animation?.cancel(), this.#w?.disconnect());
  }
  _setup() {
    let t = this._inner.firstElementChild.offsetWidth;
    if (0 === t || this._lastWidth == t) return;
    ...
    for (s = 0; s < e; s++)
      ((n = this._inner.firstElementChild.cloneNode(!0)),
        ...
        i.appendChild(n));
    if ((this._inner.append(i), (n = null), !matchMediaQuery("motion"))) return;
    ...
    this._animation = animate(
      ...
      {
        transform: [
          `translateX(${o}) translateZ(0)`,
          `translateX(${l}) translateZ(0)`,
        ],
      },
      { duration: a, easing: "linear", repeat: 1 / 0 },
    );
  }
}
...
class MegaMenu extends Accordion {
  ...
  get event() {
    return getterGet(
      _event,
      this,
      matchMediaQuery("hover") ? this.getAttribute("event") : "click",
    );
  }
  get position() {
    return getterGet(
...
((_color_limit = new WeakSet()),
  ...
  (color_limit_fn = function () {
    ...
    o >= n || r <= getterGet(_width_color_list, this)
  ...
  (color_on_hovered_fn = function (t, e) {
    ...
    if (s) {
      ...
      s !== t.getAttribute("src") &&
        getterRunFn(_create_img, this, create_img_fn).call(this, s, t);
    }
  }),
...
class LazyModal extends ModalComponent {
  ...
  async open(t = !1) {
    ...
    const i = await (
      await fetchCache(
        `${window.Shopify.routes.root}products/${e}?section_id=${getterGet(_section_ids_modal, this)}`,
      )
    ).text();
    (document.dispatchEvent(
  ...
  async close(t = !1) {
    (await super.close(t), (this._inner.innerHTML = ""));
  }
  get btnOpening() {
...
class TmpQuick extends HTMLElement {
  ...
  async getIDTemp() {
    ...
    let e,
      i = "themeQuick2" + window.Shopify.theme.id;
    sessionStorage.getItem(i) && !Shopify.designMode
      ? (e = sessionStorage.getItem(i))
      : ((e = await (
          await fetch(
            `${window.Shopify.routes.root}products/${t.getAttribute("handle")}?view=only_config`,
            { priority: "low" },
          )
        ).text()),
...
class ProductForm extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.form?.addEventListener("submit", this.#E.bind(this), { signal: t });
  }
  disconnectedCallback() {
    this.#t.abort();
  }
  #E(t) {
    ...
    if ((t.preventDefault(), this.form.checkBreak)) return;
    ...
    if (
      ...
      return;
    (i.setAttribute("disabled", "true"), i.setAttribute("aria-busy", "true"));
    const s = new FormData(this.form);
    s.append("sections", this.cart.sectionId);
    const n = fetchConfig("javascript", { body: s });
    fetch(`${Shopify.routes.root}cart/add.js`, {
      ...n,
      headers: { ...n.headers, Accept: "text/html" },
    })
      .then((t) => t.json())
      .then((t) => {
        if (
          ...
          if (
            (window.dispatchEvent(new CartErrorEvent(this.id, t.message)), !e)
          )
            return;
          return (
        ...
        }
        {
          ...
          if (
            (e && (e.classList.add("hidden"), e.removeAttribute("aria-live")),
            !n)
          )
...
((_update_bundle_total = new WeakSet()),
  (update_bundle_total_fn = function (t) {
    ...
    (e &&
      ...
      ($4(".hdt-money", e).outerHTML =
        `<span class="hdt-money">${formatMoney(this.totalComparePrice)}</span>`)),
      ($4(
        "hdt-price .hdt-money",
        getterGet(_update_total_bundle, this),
      ).outerHTML =
        `<span class="hdt-money">${formatMoney(this.totalPrice)}</span>`),
  ...
  (bundle_product_fn = function (t) {
    ...
    if ("SELECT" == e.tagName) {
      ...
      if (
        ...
        ($4("[update-price] hdt-compare-at-price .hdt-money", this).outerHTML =
          `<span class="hdt-money">${formatMoney(this.comparePrice)}</span>`),
        ($4("[update-price] hdt-price .hdt-money", this).outerHTML =
          `<span class="hdt-money">${formatMoney(this.price)}</span>`),
...
((_on_variant_changed = new WeakSet()),
  (on_variant_changed_fn = function (t) {
    ...
    const btnText = $4('.hdt-btn-atc_text', i) || i.firstElementChild;
      ...
      this.masterInput &&
        ...
        $$4('fieldset[type^="dropdown"]', this).forEach((t) => {
          $4("hdt-popover", t).addEventListener(
            ...
            (e) => {
              const i = $4(
                `input[type="hidden"][name="option${parseInt(t.dataset.index) + 1}"]`,
                t,
              );
...
((_variants_data = new WeakMap()),
  ...
  (master_input_change_fn = function (t) {
    ...
    ($$4("fieldset[data-index]", this).forEach((i, s) => {
      let n = this.currentVariant.options[s],
        ...
        a = $4("[update-value]", i),
        o = $4(
          `input[type="radio"][value="${CSS.escape(n)}"], input[type="hidden"][name="option${s + 1}"]`,
          i,
        ),
        l = !1;
  ...
  (update_variant_statuses_fn = function () {
    ...
    $$4("fieldset[data-index]", this).forEach((t, e) => {
      let l = ++e;
      const elements = $$4('[type="radio"], hdt-richlist > button', t);
      elements.forEach((t) => {
        let e = !0,
          d = !0;
        switch (l) {
        ...
        (t.classList.toggle("is-disabled", d),
          ...
          t.setAttribute("aria-disabled", d));
      });
      const select = t.querySelector('.hdt-select');
      if (select) {
        const isSoldOut = Array.from(elements).some((el) => el.value === this.options[e - 1] && el.classList.contains('is-disabled'));
        select.classList.toggle('is-disabled', isSoldOut);
      }
    });
  }),
...
class Price extends VariantChangeBase {
  onVariantChanged(t) {
    const e = t.detail.variant;
    (($4(".hdt-money", this).outerHTML =
      `<span class="hdt-money">${formatMoney(e.price, currencyFormat)}</span>`),
...
class CompareAtPrice extends Price {
  onVariantChanged(t) {
    ...
    ((this.hidden = !(e.compare_at_price > e.price)),
      this.hidden ||
        (($4(".hdt-money", this).outerHTML =
          `<span class="hdt-money">${formatMoney(e.compare_at_price, currencyFormat)}</span>`),
        document.dispatchEvent(new CustomEvent("currency:update")),
        this.dispatchEvent(new CustomEvent("price:update"))));
  }
}
class UnitPrice extends Price {
  onVariantChanged(t) {
    ...
    ((this.hidden = !e.unit_price),
      this.hidden ||
        (($4(".hdt-money", this).outerHTML =
          `<span class="hdt-money">${formatMoney(e.unit_price, currencyFormat)}</span>`),
        document.dispatchEvent(new CustomEvent("currency:update")),
        this.dispatchEvent(new CustomEvent("price:update"))));
  }
}
class QtyPrice extends Price {
  ...
  onVariantChanged(t) {
    const e = t.detail.variant;
    if (e) {
      this.setAttribute("variant-price", e.price);
      this.hidden = !e.available;
      this.updatPrice();
    } else {
      this.hidden = !0;
    }
  ...
  updatPrice() {
    ...
    (($4(".hdt-money", this).outerHTML =
      `<span class="hdt-money">${formatMoney(t * (this.qty ? this.qty.value : 1), currencyFormat)}</span>`),
      document.dispatchEvent(new CustomEvent("currency:update")));
  }
}
...
class StickyATC extends VariantChangeBase {
  ...
  connectedCallback() {
    (getterAdd(_formElement, this, document.forms[this.getAttribute("form")]),
      ...
      getterGet(_footerElement, this) &&
        getterGet(_intersection_observer, this).observe(
          getterGet(_footerElement, this),
        ),
      this.hasAttribute("is-pr-default") ||
        (getterAdd(_sticky_select, this, $4("[tag-select]", this)),
        (this.#k = getterGet(_sticky_select, this).value),
        super.connectedCallback(),
  ...
  onVariantChanged(t) {
    ...
    if (e && this.#k != e.id) {
      ...
      const atcBtn = $4('[name="add"]', this);
      const atcText = $4('.hdt-btn-atc_text', atcBtn) || atcBtn.firstElementChild;
      atcText.textContent =
        themeHDN.extras[
          e
            ? e.variant_state.pre_order
...
((_form_atc_visible = new WeakSet()),
  (form_atc_visible_fn = function (t) {
    ...
    const e = t.find((t) => t.target === getterGet(_formElement, this)),
      ...
      s =
        !!getterGet(_footerElement, this) &&
        t.find((t) => t.target === getterGet(_footerElement, this));
    s && s.isIntersecting
  ...
  constructor() {
    (super(),
      ...
      this.input &&
        ...
        this.closest("hdt-popover")?.addEventListener(dialogOpening, (t) => {
  ...
  (lm_render_fn = async function (t) {
    ...
    const e = t.detail.url,
      ...
      r =
        ...
        document.getElementById(`shopify-section-${i}`);
    ...
    try {
      ...
      (a.lastElementChild.classList.add(`point-effect-${s}`),
        ...
        matchMediaQuery("motion") &&
          ((a.prependEl = `.point-effect-${s} ~ `), a.reveal()));
...
class QuantityWrapp extends HTMLElement {
  #t;
  constructor() {
    (super(...arguments), getterAdd(_qty_inputs, this, $4("input", this)));
  }
  get input() {
    ...
    (this.validateQtyRules(),
      this.input.dispatchEvent(
        new QuantitySelectorUpdateEvent(
          ...
          Number(this.input.dataset.index),
        ),
      ));
  }
  onButtonClick(t) {
...
((_block_required_froms = new WeakMap()),
  ...
  (block_required_on_submit_fn = function (t) {
    this.checked ||
      t.target?.getAttribute("id") !== this.attrForm ||
      (t.preventDefault(),
      t.stopPropagation(),
...
remove_item_on_cart_fn = function (t) {
  (t.preventDefault(),
    this.dispatchEvent(
      new QuantitySelectorUpdateEvent(0, Number(this.dataset.index)),
    ));
};
class CartDiscount extends HTMLElement {
  ...
  connectedCallback() {
    ...
    t &&
      t.addEventListener("input", this.handleInputChange.bind(this), {
        signal: this.#t.signal,
      });
    const e = this.querySelector("[data-cart-discount-apply]");
    (e &&
      e.addEventListener("click", this.handleApplyClick.bind(this), {
        signal: this.#t.signal,
      }),
  ...
  async handleApplyClick(t) {
    ...
    try {
      const t = await fetch(`${Shopify.routes.root}cart/update.js`, {
          ...
          body: JSON.stringify({ discount: i, sections: n }),
        }),
        r = await t.json();
      if (t.ok && r.discount_codes[0].applicable)
        ...
        (s && (s.style.display = "block"), (e.value = ""));
      ...
      (console.error("Error applying discount:", t),
        s &&
          ((s.textContent = "Error applying discount code"),
    ...
    if (e.dataset.discountCode) {
      ...
      try {
        const t = await fetch(`${Shopify.routes.root}cart/update.js`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ discount: "", sections: i }),
          }),
          e = await t.json();
        if (t.ok) {
          (document.dispatchEvent(new CustomEvent(cartReload)),
...
class CartCountComponent extends HTMLElement {
  ...
  connectedCallback() {
    ((this.#t = new AbortController()),
      document.addEventListener(ThemeEvents.cartCount, this.#A.bind(this), {
        signal: this.#t.signal,
      }));
  }
  disconnectedCallback() {
  ...
  (update_progress_bar_fn = function () {
    const t = JSON.parse(getterGet(_color_progress_bar, this) ?? "{}"),
      e = ((t, e) => {
        ...
        return (
          i.find((e, s) => t >= e && (s === i.length - 1 || t < i[s + 1])) ??
          i[0]
        );
      })(
...
((_estimateShipping = new WeakSet()),
  ...
  (formatShippingRates_fn = function (t) {
    let e = t.map(
      (t) =>
        `<li>${t.presentment_name}: ${"0.00" == t.price ? this.langRates.free : `<span class="hdt-money">${formatMoney(this.currencyMulti(t.price), themeHDN.settings.currencyFormat)}</span>`}</li>`,
    );
  ...
  sizeBackgroundVideo() {
    ...
    (n / r < 16 / 9
      ...
      ($4("iframe", this).style.cssText =
        `max-width: 1000%; margin-left: ${i}px; margin-top: ${s}px; width: ${t}px; height: ${e}px;`));
  }
}
...
class ProductMedia extends HTMLElement {
  ...
  connectedCallback() {
    if (
      ...
      if ("zoom" == this.imageZoom && matchMediaQuery("hover")) return;
      ($$4('.hdt-product-media__main [data-media-type="image"]', this).forEach(
        (t) => {
          t.addEventListener(
            "click",
  ...
  get lightBox() {
    ...
    return (
      ...
      getterGet(_lightbox_psw_media_init, this).on(
        "uiRegister",
        getterRunFn(_ui_register, this, ui_register_fn).bind(this),
      ),
      getterGet(_lightbox_psw_media_init, this).on("openingAnimationEnd", () =>
        getterGet(_lightbox_psw_media_init, this).pswp.template.classList.add(
          "hdt-psw-animate",
        ),
      ),
      getterGet(_lightbox_psw_media_init, this).on(
        ...
        () =>
          getterGet(
            _lightbox_psw_media_init,
            this,
          ).pswp.template.classList.remove("hdt-psw-animate"),
      ),
...
((_on_variant_changed_media = new WeakSet()),
  ...
  (media_image_zoom_fn = function () {
    var t = "zoom_fade_media",
      ...
      o = "external" == r;
    (Shopify.designMode &&
      $4(".drift-zoom-pane, .drift-bounding-box")?.remove(),
  ...
  (ui_register_fn = function () {
    getterGet(_lightbox_psw_media_init, this).pswp.options.dataSource.length <
      2 ||
      ...
      getterGet(_lightbox_psw_media_init, this).pswp.ui.registerElement({
        ...
        onInit: (t, e) => {
          let i,
            ...
            r = e.getNumItems();
          for (i = 0; i < r; i++) {
            const { src: t, srcset: s, alt: r } = e.options.dataSource[i];
            n += `<div class="hdt-slider__slide" can-reveal><div class="pswp__thumbnail" data-index="${i}"><img src="${t}" srcset="${s}" alt="${r}" loading="lazy" sizes="70px"></div></div>`;
          }
          (t.insertAdjacentHTML(
            "beforeend",
            `<hdt-slider reveal-on-scroll="true" class="hdt-slider" config='{"dragFree": true,"slidesToScroll": 1,"ntCenter": true}'><div class='hdt-slider__viewport'><div class='hdt-slider__container'>${n}</div></div></hdt-slider>`,
          ),
            (n = ""),
            (e.thumbs = $$4(".pswp__thumbnail", t)),
            e.on("change", () => {
              const { currIndex: t } = e;
              (s >= 0 &&
                e.thumbs[s].classList.remove("pswp__thumbnail--active"),
                e.thumbs[t].classList.add("pswp__thumbnail--active"),
                (s = t),
                this?.slider?.goToIndex(t));
            }));
        },
        onClick: function (t, e, i) {
          const { index: s } = t.target.dataset;
          s && i.goTo(parseInt(s));
        },
      });
  }));
      ...
      a = this.images.map((t) => {
        const { src: e, currentSrc: i, alt: s } = t,
          n = renderSrcset(
            ...
            JSON.parse(
              t.dataset.widths ||
                `[246, 493, 600, 713, 823, 990, 1100, 1206, 1346, 1426, 1646, 1946, 2200, 2500, 3000, 3500, 4000, ${t.getAttribute("width")}]`,
            ),
          );
        return {
          thumbnailElement: t,
...
(customElements.define("hdt-lazy-html", lazyHTML),
  ...
  (() => {
    ...
    ($4("hdt-cart-drawer") ||
      ...
      document.addEventListener(cartUpdate, (t) => {
        const e = t.detail.actionAfterATC || themeHDN.settings.actionAfterATC;
        e.indexOf("go_") > -1 &&
          (window.location.href = `${Shopify.routes.root}${"go_cart_page" == e ? "cart" : "checkout"}`);
      }),
      $4("hdt-cart-drawer") &&
        document.addEventListener(cartUpdate, () => {
          $4("#hdt-quick-view-modal")?.hasAttribute("open") &&
            $4("#CartDrawer")?.hasAttribute("open") &&
            $4("#hdt-quick-view-modal").parentElement.close();
        }));
  })());
export {
  getterAdd,
